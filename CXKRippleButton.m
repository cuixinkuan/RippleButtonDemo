...
const CGFloat CXKFlashInnerCircleInitialRadius = 20;

@implementation CXKRippleButton
...
- (void) commonInit {
    ...
    self.buttonType = CXKFlashbuttonTypeInner;
}
...
- (void)setButtonType:(CXKFlashbuttonType)buttonType {
    if (buttonType == CXKFlashbuttonTypeInner) {
...
- (void)tapClick:(UITapGestureRecognizer *)tapGestureHandler {
    ...
    if (self.buttonType == CXKFlashbuttonTypeInner) {
        CGFloat biggerEdge = width > height ? width : height;
        CGFloat smallerEdge = width > height ? height : width;
        CGFloat radius = smallerEdge / 2 > CXKFlashInnerCircleInitialRadius ? CXKFlashInnerCircleInitialRadius : smallerEdge / 2;
